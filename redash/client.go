...
func (c *Client) doRequest(method, path, body string, form url.Values) (*http.Response, error) {
...
func (c *Client) get(path string, form url.Values) (*http.Response, error) {
	return c.doRequest(http.MethodGet, path, "", form)
}

func (c *Client) post(path string, payload string, form url.Values) (*http.Response, error) {
	return c.doRequest(http.MethodPost, path, payload, form)
}

func (c *Client) put(path string, payload string, form url.Values) (*http.Response, error) {
	return c.doRequest(http.MethodPut, path, payload, form)
}

func (c *Client) delete(path string, form url.Values) (*http.Response, error) {
	return c.doRequest(http.MethodDelete, path, "", form)
}
